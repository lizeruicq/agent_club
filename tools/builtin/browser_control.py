...
def get_playwright_chromium_executable_path():
    """Return None to let Playwright auto-detect."""
    return None

def get_system_default_browser():
    """No system default browser detection."""
    return None, None
...
def _ensure_playwright_async():
    ...
    try:
        ...
        raise ImportError(
            "Playwright not installed. Use the same Python that runs AgentScope (e.g. "
...
async def browser_use(  # pylint: disable=R0911,R0912
    ...
    Args:
        ...
        cdp_port (int):
            ...
            AgentScope chooses a free local port automatically for managed CDP.
        private_mode (bool):
            ...
            via CDP. Default False. By default, AgentScope prefers managed CDP for
